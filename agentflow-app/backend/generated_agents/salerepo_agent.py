...
Usage:
  ...
  3. Run: python salerepo_agent.py
"""
import os
import autogen
...
assistant = autogen.AssistantAgent(
    name="salerepo",
    system_message="""it must collect everydata and compile them in excel sheet""",
...
if __name__ == "__main__":
    print(f"\n============================================================")
    print(f"  AI Factory Agent: salerepo")
